...
MissingPower:AddTrans("enUS", "CMPCol", "Color")
...
MissingPower:AddTrans("enUS", "TickbarColor", "5SR Color")
MissingPower:AddTrans("enUS", "TickbarBorderColor", "5SR Border Color")
MissingPower:AddTrans("enUS", "EnergyTickbarColor", "Energy Color")
MissingPower:AddTrans("enUS", "EnergyTickbarBorderColor", "Energy Border Color")
MissingPower:AddTrans("enUS", "FIVESECONDRULE", "Five Second Rule (5SR)")
