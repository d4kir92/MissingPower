...
MissingPower:AddTrans("deDE", "showenergyticksbg", "Energie Ticks Rand anzeigen")
MissingPower:AddTrans("deDE", "showtickbarbg", "5SR Tickbar Rand anzeigen")
MissingPower:AddTrans("deDE", "TickbarColor", "5SR Farbe")
MissingPower:AddTrans("deDE", "TickbarBorderColor", "5SR Rand Farbe")
MissingPower:AddTrans("deDE", "EnergyTickbarColor", "Energie Farbe")
MissingPower:AddTrans("deDE", "EnergyTickbarBorderColor", "Energie Rand Color")
MissingPower:AddTrans("deDE", "FIVESECONDRULE", "Fünf Sekunden Regel (5SR)")
