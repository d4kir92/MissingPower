...
function MissingPower:InitSetting()
	MIPOPC = MIPOPC or {}
	MissingPower:SetVersion(AddonName, 136048, "0.4.35")
	mp_settings = MissingPower:CreateFrame(
		{
			...
			["sw"] = 520,
			["sh"] = 520,
			["title"] = format("MissingPower |T136048:16:16:0:0|t v|cff3FC7EB%s", "0.4.35")
		}
	)
	...
	MissingPower:AppendSlider("displayiflowerthanx", 10, 0, 99, 0, 1)
	MissingPower:AppendCategory("TEXT")
	MissingPower:AppendSlider("decimals", 0.7, 0.0, 2.0, 1, 0)
	MissingPower:AppendSlider("fontsize", 0.7, 6, 16, 0, 1)
	MissingPower:AppendSlider("fontanchor", 1, 0, 8, 1, 0)
	MissingPower:AppendSlider("textoffsetx", 1, -100, 100, 0, 1)
	MissingPower:AppendSlider("textoffsety", 1, -100, 100, 0, 1)
	...
	MissingPower:CreateMinimapButton(
		{
			...
			["icon"] = 136048,
			["dbtab"] = MIPOPC,
			["vTT"] = {"MissingPower", "Leftclick - Toggle Settings", "Shift + Rightclick - Hide Minimap Icon"},
			["funcL"] = function()
