...
function MissingPower:InitSetting()
	MIPOPC = MIPOPC or {}
	MissingPower:SetVersion(AddonName, 136048, "1.2.23")
	mp_settings = MissingPower:CreateFrame(
		{
			...
			["sw"] = 520,
			["sh"] = 520,
			["title"] = format("MissingPower |T136048:16:16:0:0|t v|cff3FC7EB%s", "1.2.23")
		}
	)
	...
	MissingPower:CreateMinimapButton(
		{
			...
			["icon"] = 136048,
			["dbtab"] = MIPOPC,
			["vTT"] = {{"MissingPower |T136048:16:16:0:0|t", "v|cff3FC7EB1.2.23"}, {"Leftclick", "Toggle Settings"}, {"Rightclick", "Hide Minimap Icon"}},
			["funcL"] = function()
